                    ...
                    <div class="card-body">
                        <div class="row justify-content-center" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1 form-group"  style="padding-top:5%">
                                        <input class="btn btn-primary"  type="submit" id="modificarUsuarioInterno"  name="modificar" value="Modificar">
                            </div>
                        </div>
                     </div>
                </div>                                
...
<div class="d0">
    ...
    <input type="hidden" id="id_tipo_usuario" value="<?php echo $empresa; ?>">  
</div>
