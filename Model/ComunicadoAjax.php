...
require_once "./../Controller/ComunicadoUsuarioController.php";
...
if($_POST["crud"])
{
    ...
    switch($crud)
    {
        ...
        case 'createSolicitudPermiso':
            ...
            $con_comunicado_usuario = new ComunicadoUsuarioController();
            ...
            $hora = $hoy["seconds"] . ":" . $hoy["minutes"] . ":" . $hoy["hours"];
            ...
            $comunicado->setFecha_caducidad_comunicado($_POST["fecha_caducidad_comunicado"]);
            ...
            echo $result_comunicado_usuario;
